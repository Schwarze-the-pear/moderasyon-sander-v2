...
const mutelog = message.guild.channels.cache.find(c => c.id === '779759458674540585')//Mute log
const muterol = message.guild.roles.cache.find(r => r.id === '767640411111817238')//Muteli rolü
